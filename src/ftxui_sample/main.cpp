...
// configuration step. It creates a namespace called `mega_cmake_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", mega_cmake_template::cmake::project_name, mega_cmake_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", mega_cmake_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
